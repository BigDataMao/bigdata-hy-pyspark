create or replace procedure cf_busimg.p_cockpit_00160_data(i_busi_date   in varchar2,
  ...
  -- copyright              wolf 1.0
  -- func_create_begin
  -- func_id                p_cockpit_00160_data
  -- version                1.0
  -- func_name
  -- func_remark            溯源表模板_IB驻点收入调整-数据落地
  ...
  --固定变量
  ---------------------------------------------------------------------------------------
  v_op_object  varchar2(50) default 'P_COCKPIT_00160_DATA'; -- '操作对象';
  ...
  begin
    ...
    delete from CF_BUSIMG.T_COCKPIT_00160 t where t.month_id = v_month_id;
    commit;
