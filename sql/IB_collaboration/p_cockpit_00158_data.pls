create or replace procedure cf_busimg.p_cockpit_00158_data(i_busi_date   in varchar2,
  ...
  -- copyright              wolf 1.0
  -- func_create_begin
  -- func_id                p_cockpit_00158_data
  -- version                1.0
  -- func_name
  -- func_remark            溯源表模板_IB协同收入调整-数据落地
  ...
  --固定变量
  ---------------------------------------------------------------------------------------
  v_op_object  varchar2(50) default 'P_COCKPIT_00158_DATA'; -- '操作对象';
...
begin
  ...
  delete from CF_BUSIMG.T_COCKPIT_00158 t where t.month_id = v_month_id;
  commit;
