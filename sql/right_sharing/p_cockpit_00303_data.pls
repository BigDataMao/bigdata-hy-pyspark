create or replace procedure cf_busimg.p_cockpit_00303_data(i_busi_date   in varchar2,
  ...
  -- copyright              wolf 1.0
  -- func_create_begin
  -- func_id                p_cockpit_00303_data
  -- version                1.0
  -- func_name
  -- func_remark            权益溯源_ib协同-数据落地
  ...
  --固定变量
  ---------------------------------------------------------------------------------------
  v_op_object  varchar2(50) default 'P_COCKPIT_00303_DATA'; -- '操作对象';
