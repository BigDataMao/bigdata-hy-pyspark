...
from src.utils.get_oracle_ddl import get_oracle_ddl
from src.utils.oracle_ddl_to_hive_ddl import oracle_ddl_to_hive, generate_hive_ddl
from src.utils.tools import csv_to_dict_list, clean_table_info
...
# 项目目录为当前目录的上上级目录
project_dir = path.join(current_dir, '..', '..')
# table_info.csv 文件路径
table_info_file = path.join(project_dir, 'data/input/dwd_table.csv')
